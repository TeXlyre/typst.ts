...
export class TypstWorld {
  ...
  /**
   * Set the PDF export options used by subsequent exports from this world.
   *
   * @param {RenderPdfOpts} opts - The PDF options to set.
   */
...
export interface TypstCompiler {
  ...
  /**
   * Set the PDF export options applied when the compiler is built.
  ...
  /**
   * Set the PDF export options applied to every subsequent compilation.
   * @param {RenderPdfOpts} opts - The PDF options to set.
   */
